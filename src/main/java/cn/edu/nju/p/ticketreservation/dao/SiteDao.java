...
public interface SiteDao {
    ...
    @Insert({"insert into site(province,city,avenue,name,seat_count_x,seat_count_y,seat_count_z) values " +
            "(#{site.province},#{site.city},#{site.avenue},#{site.name},#{site.seatCountX},#{site.seatCountY},#{site.seatCountZ})"})
